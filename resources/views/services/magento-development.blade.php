            ...
            <div class="col-lg-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Magento Development</li>
                    </ol>
                </nav>
                <div class="aos-init" data-aos="fade-up">
                    <h3 class="subtitle d-flex align-items-center"> <span></span>Magento Development</h3>
                    <p class="sub-dec ms-4 mt-4">In today's digital era, e-commerce has become a vital aspect of
                        every business. It allows businesses to reach out to their customers globally, offer a
                        seamless shopping experience, and generate revenue 24/7. From design and development to
                        customization and maintenance, Plutus Technologies, a Magento Development Company has an
                        experienced team of Magento experts who will help you build a powerful, feature-rich online
                        store that reflects your brand's identity and values.</p>
                </div>
            </div>
            <div class="col-lg-6 text-center">
                <div class="page-breadcrumb-img">
                    <img src="{{ asset('image/magento-development-banner-image.svg') }}" class="w-100" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="about-ios-app-development">
    <div class="container space aos-init" data-aos="fade-up" data-aos-delay="400">
        <h3 class="subtitle d-flex align-items-center"> <span></span>About Magento Development</h3>
        <p class="sub-dec">The Magento platform has emerged as one of the most popular platforms for developing
            e-commerce websites in recent years. Its popularity stems from the fact that it offers a scalable and
            adaptable infrastructure that can cater to e-stores of all sizes. A robust and reliable online store can
            be built by Magento regardless of whether you're a small business owner or a large corporation.
            Magento's customizability is one of its key advantages. Secure payment options, order management, and
            product management are just some of the features offered by the platform that ensure the security of
            your online store.
...
<div class="engagement-models ios-app-development-boxes bg-lightblue-100 space">
    <div class="container aos-init" data-aos="fade-up">
        <h3 class="subtitle d-flex align-items-center"> <span></span>Our Magento Development Services</h3>
    </div>
        ...
        <div class="row">
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="200">
                <div class="engagement-models-box bg-lightblue">
                    <img src="{{ asset('image/magento-development-box-1.svg') }}" class="" alt="">
                    <h3 class="mb-0">Magento Consulting Services</h3>
                    <div class="engement-overly-div bg-lightblue">
                        <h3 class="mb-0">Magento Consulting Services</h3>
                        <p>Plutustec Magento consulting services provide expert guidance to help businesses choose
                            the right Magento solutions and strategies for their specific needs.
                        </p>
                    </div>
                </div>
            </div>
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="300">
                <div class="engagement-models-box bg-lightorange">
                    <img src="{{ asset('image/magento-development-box-2.svg') }}" class="" alt="">
                    <h3 class="mb-0">Responsive Magento Themes</h3>
                    <div class="engement-overly-div bg-lightorange">
                        <h3 class="mb-0">Responsive Magento Themes</h3>
                        <p>The Magento themes we create are responsive across all devices and visually stunning.
                        </p>
                    </div>
                </div>
            </div>
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="400">
                <div class="engagement-models-box bg-lightblue">
                    <img src="{{ asset('image/magento-development-box-3.svg') }}" class="" alt="">
                    <h3 class="mb-0">Magento Migration Services</h3>
                    <div class="engement-overly-div bg-lightblue">
                        <h3 class="mb-0">Magento Migration Services</h3>
                        <p>Offering seamless migration services to businesses to make the switch from
                            their current platform to Magento.</p>
                    </div>
                </div>
            </div>
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="500">
                <div class="engagement-models-box bg-lightorange">
                    <img src="{{ asset('image/magento-development-box-4.svg') }}" class="" alt="">
                    <h3 class="mb-0">Magento Upgradation & Integration</h3>
                    <div class="engement-overly-div bg-lightorange">
                        <h3 class="mb-0">Magento Upgradation & Integration</h3>
                        <p>The latest Magento versions and integrations can always be managed through our Magento
                            updating and integration services, that ensure businesses are always up-to-date with the
                            latest Magento versions.</p>
                    </div>
                </div>
            </div>
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="600">
                <div class="engagement-models-box bg-lightblue">
                    <img src="{{ asset('image/magento-development-box-5.svg') }}" class="" alt="">
                    <h3 class="mb-0">Magento Support & Maintenance</h3>
                    <div class="engement-overly-div bg-lightblue">
                        <h3 class="mb-0">Magento Support & Maintenance</h3>
                        <p>We run along for delivering support and maintenance through the process and also resolve
                            any issues and confirm their websites run smoothly.
                        </p>
                    </div>
                </div>
            </div>
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="700">
                <div class="engagement-models-box bg-lightorange">
                    <img src="{{ asset('image/magento-development-box-6.svg') }}" class="" alt="">
                    <h3 class="mb-0">Multi-Vendor Marketplace</h3>
                    <div class="engement-overly-div bg-lightorange">
                        <h3 class="mb-0">Multi-Vendor Marketplace</h3>
                        <p>Allowing businesses to create online marketplaces with multiple sellers and a variety of
                            products.</p>
                    </div>
                </div>
            </div>
...
<div class="benefits-ios space">
    <div class="container aos-init" data-aos="fade-up">
        <h3 class="subtitle d-flex align-items-center"> <span></span>Benefits of Developing an Magento
        </h3>
    </div>
        ...
        <div class="row benefits-ios-row mx-0">
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-1">
                <div class="benefits-ios-box">
                    <h3>
                        Magento is an open-source platform, which means that it can be customized and extended to
                        integrate with other software and tools.
                    </h3>
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-2">
                <div class="benefits-ios-box">
                    <h3>
                        Magento Ecommerce Development Services offers a wealth of built-in features and third-party
                        integrations, making it a versatile choice for businesses of all sizes.
                    </h3>
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-3">
                <div class="benefits-ios-box">
                    <h3>
                        Performance efficiently with built-in SEO features, which help to boost a store's visibility
                        in search engines.
                    </h3>
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-4">
                <div class="benefits-ios-box">
                    <h3>
                        Speedy page loading times and efficient order processing are attributed to a well-optimized
                        database structure.
                    </h3>
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-5">
                <div class="benefits-ios-box">
                    <h3>
                        As a community-driven platform, Magento has an extensive user and developer community.
                    </h3>
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-6">
                <div class="benefits-ios-box">
                    <h3>
                        Business organizations have access to a variety of resources, such as forums, user groups,
                        and documentation for developers.</h3>
                </div>
            </div>
...
<div class="call-to-action ios-call-to-action aos-init" data-aos="fade-up">
    <div class="container aos-init" data-aos="fade-up" data-aos-delay="600">
        <div class="call-to-action-content">
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <h2>Let's Discuss Your Magento Idea</h2>
                </div>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="200">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Magento is a free and open-source content management system (CMS) for building
                                websites.
                            </li>
                        </ul>
                    </div>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="300">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="cursor-hover accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        Can I customize the design of my Magento site?
                    </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Yes, magento has a wide range of customizable themes available for free and paid
                                use.
                            </li>
                        </ul>
                    </div>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="400">
                <h2 class="accordion-header" id="headingThree">
                    <button class="cursor-hover accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        Can I add plugins to extend the functionality of my Magento site?
                    </button>
                </h2>
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Yes, Magento has a large library of free and paid plugins that can be added to
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="500">
                <h2 class="accordion-header" id="headingFour">
                    <button class="cursor-hover accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        Is Magento good for the biggest websites?
                    </button>
                </h2>
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Yes, Magento is widely used by best brands across the globe due to its simple
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="500">
                <h2 class="accordion-header" id="headingFive">
                    <button class="cursor-hover accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        How can I improve the security of my Magento site?
                    </button>
                </h2>
                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                The security of a Magento site can be improved through the use of plugins, regularly
                                updating software, and following best practices for security.
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="500">
                <h2 class="accordion-header" id="headingSix">
                    <button class="cursor-hover accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        How do I make my Magento site mobile-friendly?
                    </button>
                </h2>
                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Yes, mobile-friendly magento site can be achieved by using a responsive theme or
                                plugin.
                            </li>
                        </ul>
                    </div>
...
<div class="call-to-action aos-init" data-aos="fade-up">
    <div class="container aos-init" data-aos="fade-up" data-aos-delay="600">
        <div class="call-to-action-content">
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <h2>Hire Magento Developer</h2>
                </div>
                <div class="col-lg-3 text-center">
                    <a href="hire-magento-app-developer" class="cursor-hover btn btn-primary">Click Here</a>
                </div>
            </div>
        </div>
    </div>
