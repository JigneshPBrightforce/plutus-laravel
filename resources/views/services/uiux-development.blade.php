        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="aos-init" data-aos="fade-up">
                    <h3 class="subtitle d-flex align-items-center"> <span></span>UI/UX Design</h3>
                    <p class="sub-dec ms-4 mt-4">Plutus Technologies attempts to understand the core of your brand
                        and
                        transform it into an interface that resonates with your target audience through an iterative
                        and collaborative process. We seek to convert casual visitors into ardent supporters of your
                        digital domain by developing intuitive navigation frameworks, flawless transitions, and
                        enjoyable microinteractions. Our UI and UX Design Company strives for greatness by
                        conducting extensive user research, prototyping, and rigorous testing to perfect our
                        products..</p>
                </div>
            </div>
            <div class="col-lg-6 text-center">
                <div class="page-breadcrumb-img">
                    <img src="{{ asset('image/uiux-development-banner-image.svg') }}" class="w-100" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="about-ios-app-development">
    <div class="container space aos-init" data-aos="fade-up" data-aos-delay="400">
        <h3 class="subtitle d-flex align-items-center"> <span></span>About UI/UX Design</h3>
        <p class="sub-dec">Adherence to the latest UI patterns appears as a crucial need in the goal of achieving an
            optimal level of triumph in the field of online business. Extremely influential, excellent UI design
            acts as a catalyst in enticing new customers and cultivating the loyalty of existing ones, providing
            them with an unhindered and seamless experiential journey.
            Our advanced UI and UX Development Service portfolio of versatile and mobile-friendly designs serves as
            a steadfast guarantee, ensuring your valued client's constant access to your digital presence,
            regardless of their chosen devices or platforms. Pluto tec’s UI/UX endeavors exceed conventional
            paradigms by effortlessly combining progressive technological acumen with artistic refinement,
            comprising a harmonic combination of user-centricity, intuitive navigation, and aesthetically appealing
            visual features.
...
<div class="engagement-models ios-app-development-boxes bg-lightblue-100 space">
    <div class="container aos-init" data-aos="fade-up">
        <h3 class="subtitle d-flex align-items-center"> <span></span>Our UI/UX Design Services</h3>
    </div>
        ...
        <div class="row">
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="200">
                <div class="engagement-models-box bg-lightblue">
                    <img src="{{ asset('image/uiux-development-box-1.svg') }}" class="" alt="">
                    <h3 class="mb-0">PSD to HTML/HTML5 Conversion</h3>
                    <div class="engement-overly-div bg-lightblue">
                        <h3 class="mb-0">PSD to HTML/HTML5 Conversion</h3>
                        <p>Our company specializes in delivering the smooth UI and UX Development Service
                            aimed at transforming PSD files into impeccably coded HTML5 web pages that adhere to the
                            W3C standards. Furthermore, we possess the capability to enhance the page quality and
                            performance of existing websites through our conversion expertise.
                        </p>
                    </div>
                </div>
            </div>
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="300">
                <div class="engagement-models-box bg-lightorange">
                    <img src="{{ asset('image/uiux-development-box-2.svg') }}" class="" alt="">
                    <h3 class="mb-0">UI/UX Design</h3>
                    <div class="engement-overly-div bg-lightorange">
                        <h3 class="mb-0">UI/UX Design</h3>
                        <p>The paramount importance of user experience in relation to your brand cannot be
                            overstated. A meticulously crafted UI/UX Design Services holds the potential to provide
                            the optimal user experience that aligns perfectly with your brand's vision and
                            objectives.
                        </p>
                    </div>
                </div>
            ...
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="400">
                <div class="engagement-models-box bg-lightblue">
                    <img src="{{ asset('image/uiux-development-box-3.svg') }}" class="" alt="">
                    <h3 class="mb-0">Responsive Web Design</h3>
                    <div class="engement-overly-div bg-lightblue">
                        <h3 class="mb-0">Responsive Web Design</h3>
                        <p>Given the exponential increase in mobile users, it has become critical to guarantee that
                            your website is flawlessly adaptable across various screen sizes. Our flexible layout
                            strategy ensures excellent rendering on all mobile devices, leading in a better user
                            experience.</p>
                    </div>
                </div>
            </div>
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="500">
                <div class="engagement-models-box bg-lightorange">
                    <img src="{{ asset('image/uiux-development-box-4.svg') }}" class="" alt="">
                    <h3 class="mb-0">Mobile App Design</h3>
                    <div class="engement-overly-div bg-lightorange">
                        <h3 class="mb-0">Mobile App Design</h3>
                        <p>Mobile applications have become an essential component of any online business. A
                            compelling and carefully designed mobile app interface surely provides a significant
                            boost.</p>
                    </div>
                </div>
            </div>
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="600">
                <div class="engagement-models-box bg-lightblue">
                    <img src="{{ asset('image/uiux-development-box-5.svg') }}" class="" alt="">
                    <h3 class="mb-0">Graphic Design</h3>
                    <div class="engement-overly-div bg-lightblue">
                        <h3 class="mb-0">Graphic Design</h3>
                        <p>Visual representations can express far more about your brand than a slew of words ever
                            could. Graphics that are both compelling and appealing to the eye have the ability to
            ...
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="700">
                <div class="engagement-models-box bg-lightorange">
                    <img src="{{ asset('image/uiux-development-box-6.svg') }}" class="" alt="">
                    <h3 class="mb-0">Bootstrap Framework</h3>
                    <div class="engement-overly-div bg-lightorange">
                        <h3 class="mb-0">Bootstrap Framework</h3>
                        <p>We specialize in custom bootstrap frameworks for websites and administration panels, with
                            the added benefit of reusability across other bootstrap-enabled websites in your
                            portfolio.</p>
                    </div>
                </div>
            </div>
...
<div class="benefits-ios space">
    <div class="container aos-init" data-aos="fade-up">
        <h3 class="subtitle d-flex align-items-center"> <span></span>Benefits of UI/UX Design
        </h3>
    </div>
        ...
        <div class="row benefits-ios-row mx-0">
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-1">
                <div class="benefits-ios-box">
                    <h3>
                        Effective UI/UX designs increase user engagement, keeping them interested and boosting
            ...
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-2">
                <div class="benefits-ios-box">
                    <h3>
                        Brand that enjoys a positive perception of the brand because of its visually stunning and
                        user-friendly UI/UX design will be perceived as credible and trustworthy in the future.
                    </h3>
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-3">
                <div class="benefits-ios-box">
                    <h3>
                        User-centric UI/UX designs remove obstacles and simplify user journeys, maximizing
                        conversions and minimizing user drop-off.
                    </h3>
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-4">
                <div class="benefits-ios-box">
                    <h3>
                        In a competitive market, UI/UX design provides a competitive advantage, attracting and
                        retaining customers.
                    </h3>
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-5">
                <div class="benefits-ios-box">
                    <h3>
                        An accessibility-friendly UI/UX increases mobile adoption and caters to the growing number
                        of users accessing the internet from their mobile devices
                    </h3>
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-4 benefits-ios-box-6">
                <div class="benefits-ios-box">
                    <h3>
                        A superior UI/UX design provides a competitive advantage, attracting and retaining customers
                        in a crowded market.</h3>
                </div>
            </div>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="200">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Here are some of the key UI/UX design services we provide at Plutustec:
                            </li>
                            <li>Logo Designing</li>
                            <li>Wireframe Designing</li>
                            <li>Brochures & Catalog</li>
                            <li>Posters & Banner Designing</li>
                            <li>Responsive design</li>
                            <li>Web and Mobile UI Design</li>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="300">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                UX designers utilize user research, strategy, and content development to think about
                                the end-to-end user experience.
                                UI designers use design research, logo, and responsive design to translate the look
                                and feel of a digital product across devices.
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="400">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                At Platatac, UI/UX projects start with a kick-off meeting over the call or with the
                                client. During this meeting, we’ll understand the requirements of your app
                                or website. As per the requirements, We'll start as per requirements, then conduct a
                                competitive analysis before wireframing your website or application.
                                We involve our clients in every phase of the design process. The project ends when
                                our client is happy with the completed delivery of the designs.
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="500">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Here are some of the software we use for UI/UX design:
                            </li>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="500">
                ...
                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Our company works on UI/UX design. This includes the web design of websites and
                                graphics designing, custom software applications, and mobile apps.
                                However, if you are looking to change the desired actions of your users through a
                                new website or app design, we can help with Research design,
