        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 text-center">
                <div class="page-breadcrumb-img">
                    <img src="{{ asset('image/drupal-development-banner-image.svg') }}" class="w-100"
                        alt="deupal-banner">
                </div>
            </div>
        </div>
...
<div class="engagement-models ios-app-development-boxes bg-lightblue-100 space">
    <div class="container aos-init" data-aos="fade-up">
        <h3 class="subtitle d-flex align-items-center"> <span></span>Our Drupal Development Services</h3>
    </div>
        ...
        <div class="row">
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="200">
                <div class="engagement-models-box bg-lightblue">
                    <img src="{{ asset('image/drupal-development-box-1.svg') }}" class="" alt="drupal-service1">
            ...
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="300">
                <div class="engagement-models-box bg-lightorange">
                    <img src="{{ asset('image/drupal-development-box-2.svg') }}" class="" alt="drupal-service2">
            ...
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="500">
                <div class="engagement-models-box bg-lightorange">
                    <img src="{{ asset('image/drupal-development-box-4.svg') }}" class="" alt="drupal-service4">
            ...
            <div class="model-box col-md-6 col-lg-4 mb-3 mb-md-0 aos-init" data-aos="fade-up" data-aos-delay="600">
                <div class="engagement-models-box bg-lightblue">
                    <img src="{{ asset('image/drupal-development-box-5.svg') }}" class="" alt="drupal-service5">
...
<div class="benefits-ios space">
    <div class="container aos-init" data-aos="fade-up">
        <h3 class="subtitle d-flex align-items-center"> <span></span>Benefits of Developing an Drupal
        </h3>
    </div>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="200">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Drupal is a free and open-source content management system (CMS) for building
                                websites.
                            </li>
                        </ul>
                    </div>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="300">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Yes, Drupal has a wide range of customizable themes available for free and paid
                                use.
                            </li>
                        </ul>
                    </div>
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="400">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Yes, drupal has a large library of free and paid plugins that can be added to
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="500">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Yes, drupal is widely used by best brands across the globe due to its simple
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="500">
                ...
                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                The security of a drupal site can be improved through the use of plugins, regularly
            ...
            <div class="accordion-item aos-init" data-aos="fade-up" data-aos-delay="500">
                ...
                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                Yes, mobile-friendly drupal site can be achieved by using a responsive theme or
                                plugin.
                            </li>
                        </ul>
                    </div>
