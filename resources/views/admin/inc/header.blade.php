            ...
            <div class="d-flex align-items-center justify-content-between w-100">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
                    <ul class="navbar-nav align-items-center">
                        <li class="nav-item">
                            <a class="nav-link p-0 {{ Request::is('admin/dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard')}}">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link p-0 ms-3 {{ Request::is('admin/portfolio') ? 'active' : '' }}" href="{{ route('admin.portfolio')}}">Portfolio</a>
                        </li>
                        <li class="nav-item">
