            ...
            <div class="d-flex align-items-center justify-content-between w-100">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link p-0 ms-3 {{ Request::is('admin/casestudy') ? 'active' : '' }}"
                                href="{{ route('admin.casestudy')}}">Casestudy</a>
                        </li> -->
                        <li class="nav-item">
                            <a class="nav-link p-0 ms-3" title="Logout" href="{{ route('logout')}}"><img
                                    src="{{ asset('admin/images/logout.svg')}}" width="32" height="32"
                                    alt="Logout" /></a>
                        </li>
                    </ul>
                </div>
