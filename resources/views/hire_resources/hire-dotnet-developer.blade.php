...
<div class="hire-developer space">
    <div class="container aos-init" data-aos="fade-up" data-aos-delay="400">
        <h3 class="subtitle d-flex align-items-center"> <span></span>About Hire .NET Developer</h3>
    </div>
    <div class="container aos-init" data-aos="fade-up" data-aos-delay="400">
        <div class="row align-items-center">
            <div class="col-lg-7">
            ...
            <div class="col-lg-5 text-center">
                <div class="page-breadcrumb-img">
                    <img src="{{ asset('image/hire-dotnet-developer.svg')}}" class="w-100" alt="hire-php">
                </div>
            </div>
        </div>
    </div>
...
<div class="why-hire-developer space">
    <div class="space pt-0">
        <div class="container aos-init" data-aos="fade-up" data-aos-delay="400">
            <h3 class="subtitle d-flex align-items-center"><span></span>Why Hire .NET Developers from Plutustec ?
            </h3>
        </div>
