                    ...
                    <table style="padding: 10px 10px 10px 10px; max-width: 740px;width:100%; margin: 0px auto;" cellpadding="0" cellspacing="0">
                        ...
                        <tr style="background-color:#FFF3EE">
                            ...
                            <td style="padding-left: 10px;">
                                <p style="color: #020202;font-weight: 300;font-size: 14px;">
                                    @if($file_type === 'pdf')
                                    <img src="{{ asset('image/pdf.png') }}" width="28" style="display: inline-block;vertical-align: middle;" alt="resume" />
                                    @else
                                    <img src="{{ asset('image/doc.png') }}" width="28" style="display: inline-block;vertical-align: middle;" alt="resume" />
                                    @endif
                                    <a style="margin-left: 5px;color: #000000;text-decoration: none;display: inline-block;vertical-align: middle;" href="">{{$resume}}</a>
                                </p>
                            </td>
                        </tr>
                    </table>
