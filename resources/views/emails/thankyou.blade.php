...
<body style="font-family: 'Roboto', sans-serif;">
    <table style="padding: 0px; max-width: 740px;width:100%; margin: 0px auto;" cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
                <td>
                    <img src="{{ asset('image/web_email_design.png') }}" alt="Ecommerce" style="max-width: 450px; height:auto; margin:60px auto; display: block;" />
                </td>
            </tr>
            <tr>
                <td style="width:100%;border: 0;text-align: center;padding: 0 0 40px">
                    <h4 style="font-size: 30px;margin:0;font-weight: 500; padding: 0px 0px">Thank you for joining with us</h4>
                ...
                <td>
                    <div style="width: 100%;background-color: #ffffff;height:auto; text-align: center;align-items: center; padding: 20px 0px;">
                        <a href="{{ env('APP_URL') }}" target=" _blank" style="text-align:center;display: block;">
                            <img src="{{ asset('image/Plutus-logo.png') }}" alt="Logo" style="height: 60px;margin: auto;"></a>
                        ...
                        <p style="color: #020202;font-size: 12px;font-weight: 400;">1222-1223 Zion Z1 , Off Sindhu Bhavan Road, Nr. Avalon Hotel, Bodakdev , Ahmedabad 380054
                        </p>
                        <p style="color: #020202;font-size: 12px;font-weight: 400;"> copyright @ {{ date('Y')}} <span style="color: #ff6c37;"> Plutus Technologies Pvt.Ltd.</span></p>
                    </div>
                </td>
            </tr>
        </tbody>
