        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="aos-init" data-aos="fade-up">
                    ...
                    <p class="sub-dec ms-4 mt-4">Study for your exam from anywhere</p>
                </div>
            </div>
...
<div class="portfolio-detail">
    <div class="container space aos-init" data-aos="fade-up" data-aos-delay="400">
        <p class="sub-dec">Use your smart device to change your future! Skilled Trade Exams provides access to auto-generated multiple choice exam questions to prepare you for license and certification test questions that can be found in real-test scenarios.</p>
    </div>
</div>
